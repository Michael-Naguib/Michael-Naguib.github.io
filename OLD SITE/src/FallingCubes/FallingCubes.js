      ...
      <Container fluid>
        <Row>
          <Col md={12} style={{ padding: '75px', color: 'white' }}>
            <h2> Gallery </h2>
            <par>
              While looking into how I might approach creating a Mandlebulb fractal I came across
              some software I had previously seen ... but until now I did not realize what I could
              do with it I had previously just thought it good for viewing .stl files ... I was
              wrong ... I began expiramenting with some raytraced falling cube animations.
            </par>
          </Col>
          <Col lg={4}>
          ...
          <Col lg={8}>
            <Image
              style={{ height: '350px' }}
              src={process.env.PUBLIC_URL + '/RLaPinkFallingCubes.png'}
            />
          </Col>
          <Col lg={6}>
            <Image
              style={{ height: '400px' }}
              src={process.env.PUBLIC_URL + '/MyFirstCubeRender.png'}
            />
          </Col>
          <Col lg={6}>
            <Image
              style={{ height: '250px' }}
              src={process.env.PUBLIC_URL + '/RBlueFallingCubes.png'}
            />
          </Col>
        </Row>
      </Container>
