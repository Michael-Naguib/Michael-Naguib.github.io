        ...
        <Col xs={6} md={4}>
          <a href="https://www.linkedin.com/in/michael-naguib-969591170/">
            <Image
              ...
              style={{ height: '80px' }}
              src={process.env.PUBLIC_URL + '/LI-Bug.svg.original.svg'}
            />
          </a>
        </Col>
        <Col xs={6} md={4}>
          <a href="mailto:1Michael.Naguib@gmail.com">
            <Image
              className="ContactImage"
              style={{ height: '90px' }}
              src={process.env.PUBLIC_URL + '/iconfinder_gmail_1220367.svg'}
            />
          </a>
        </Col>
        <Col xs={6} md={4}>
          <a href="https://github.com/Michael-Naguib">
            <Image
              className="ContactImage"
              style={{ height: '90px' }}
              src={process.env.PUBLIC_URL + '/Octocat.svg'}
            />
          </a>
        </Col>
        <Col xs={6} md={4}>
          <a href={process.env.PUBLIC_URL + '/Michael-Naguib-Resume-9-10-2021.pdf'} download>
            <Image
              className="ContactImage"
              style={{ height: '90px' }}
              src={process.env.PUBLIC_URL + '/icons8-document.svg'}
            />
          </a>
        </Col>
        <Col xs={6} md={4}>
        ...
        <Col xs={6} md={4}>
          <a href="tel:919-710-9686">
            <Image
              className="ContactImage"
              style={{ height: '90px' }}
              src={process.env.PUBLIC_URL + '/communications.svg'}
            />
          </a>
        </Col>
      </Row>
  ...
  return (
    <div id="Contact">
      <UnsplashPhoto
        ...
        photographerUrl={dark ? '#' : ''}
        photographer={dark ? 'My Friend Ryan Dondalski' : ''}
        ...
        <Container>
          <Row style={{ padding: '0% 0% 10% 0%' }}>
            ...
            <Col
              ...
              xs={12}
              md={6}
              style={{ borderRadius: '0.25em', color: fontColor, paddingTop: '70px' }}
            >
              <Media />
            </Col>
          </Row>
