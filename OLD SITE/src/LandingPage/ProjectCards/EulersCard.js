    ...
    <Card className={dark ? 'bg-dark text-white' : 'bg-light text-black'} text={fontColor}>
      <a href="https://github.com/Michael-Naguib/ProjectEuler" className={'ProjectsLink'}>
        ...
        <Card.Body bg={dark ? 'Dark' : 'Light'}>
          ...
          <Card.Text>
            Project Euler a website containing mathematical challenges to solve and implement as you
            see fit. As I mentioned ... I like to code ... I often find the challenges fun and a
            great way to learn!
          </Card.Text>
        </Card.Body>
      </a>
