    ...
    <Card className={dark ? 'bg-dark text-white' : 'bg-light text-black'} text={fontColor}>
      <a href="https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life" className={'ProjectsLink'}>
        <video
          ...
          src={process.env.PUBLIC_URL + '/CatepillarRave.mp4'}
          autoPlay="true"
          loop
          muted
        ></video>
        <Card.Body bg={dark ? 'Dark' : 'Light'}>
          ...
          <Card.Text>
            Conway's Game of Life implemented using emojis 🐛! A 3D raytraced version using semi
            transparent cubes is on the way ...
          </Card.Text>
        </Card.Body>
        <Card.Text>
