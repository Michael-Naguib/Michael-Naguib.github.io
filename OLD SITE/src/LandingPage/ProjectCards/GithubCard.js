    ...
    <Card className={dark ? 'bg-dark text-white' : 'bg-light text-black'} text={fontColor}>
      <a href={'https://github.com/Michael-Naguib/'} className={'ProjectsLink'}>
        ...
        <Card.Body bg={dark ? 'Dark' : 'Light'}>
          ...
          <Card.Text>
            Checkout my github! Although all of my code is open source, I cannot release every side
            project I am working on until it has reached some level of maturity. These are the tip
            of the iceberg!
          </Card.Text>
        </Card.Body>
      </a>
