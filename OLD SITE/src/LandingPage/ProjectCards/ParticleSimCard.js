    ...
    <Card className={dark ? 'bg-dark text-white' : 'bg-light text-black'} text={fontColor}>
      <a href="https://github.com/Michael-Naguib/BoidsSimulation" className={'ProjectsLink'}>
        <video
          ...
          src={process.env.PUBLIC_URL + '/BoidsSimGif.mp4'}
          autoPlay="true"
          loop
          muted
        ></video>
        <Card.Body bg={dark ? 'Dark' : 'Light'}>
          ...
          <Card.Text>
            <MathJax.Provider>
              An implementation of Craig Renyolds Boids done in{' '}
              <MathJax.Node inline formula={bigO} /> by fractally subdividing space using a KD-Tree
