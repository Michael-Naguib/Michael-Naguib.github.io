    ...
    <Card className={dark ? 'bg-dark text-white' : 'bg-light text-black'} text={fontColor}>
      <a href="https://github.com/Michael-Naguib/Simple-Cryptography" className={'ProjectsLink'}>
        <video
          ...
          src={process.env.PUBLIC_URL + '/tenor.mp4'}
          autoPlay="true"
          loop
          muted
        ></video>
        <Card.Body bg={dark ? 'Dark' : 'Light'}>
          ...
          <Card.Text>
            One of my earliest projects where I implemented several encryption algorithms: Vigenere,
            Hills, Affine & Caesar; in addition to implementing frequency analysis to automatically
