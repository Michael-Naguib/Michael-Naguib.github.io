...
function PrivatePolicy() {
  return (
    <div>
      ...
      <p>
        At Michael Naguib, accessible from michael-naguib.github.io, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types of information that
        is collected and recorded by Michael Naguib and how we use it.
      </p>
      ...
      <p>
        Michael Naguib follows a standard procedure of using log files. These files log visitors
      ...
      <p>
        Like any other website, Michael Naguib uses 'cookies'. These cookies are used to store
      ...
      <p>
        ...
        Michael Naguib. Our Privacy Policy was created with the help of the{' '}
        <a href="https://www.privacypolicygenerator.org">Free Privacy Policy Generator</a> and the{' '}
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on Michael
        Naguib, which are sent directly to users' browser. They automatically receive your IP
      ...
      <p>
        Note that Michael Naguib has no access to or control over these cookies that are used by
      ...
      <p>
        Michael Naguib's Privacy Policy does not apply to other advertisers or websites. Thus, we
      ...
      <p>
        Michael Naguib does not knowingly collect any Personal Identifiable Information from
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in Michael Naguib.
