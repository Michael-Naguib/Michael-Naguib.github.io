...
window.MichaelNaguibSiteData = {
  ...
  gtag: () => {
    console.log('GTagFuncNotSpecified')
  },
}
...
function GoogleAnalyitics() {
  ...
  useEffect(() => {
    ...
    if (window.MichaelNaguibSiteData.privatePolicyAccepted) {
      ...
      window.MichaelNaguibSiteData.gtag('config', window.MichaelNaguibSiteData.GA_MEASUREMENT_ID, {
  ...
  <BrowserRouter>
    <Switch>
      ...
      <Route exact path="/" component={LandingPage} />
      {
        ...
        data.map((article) => (
          <Route exact key={article.title} path={article.pLink} component={article.component} />
        ))
      }
